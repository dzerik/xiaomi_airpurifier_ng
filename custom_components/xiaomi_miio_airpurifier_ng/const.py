...
FEATURE_FLAGS_AIRPURIFIER_PRO_V7: Final = (
    FEATURE_SET_CHILD_LOCK | FEATURE_SET_LED | FEATURE_SET_FAVORITE_LEVEL | FEATURE_SET_VOLUME
)

FEATURE_FLAGS_AIRPURIFIER_2S: Final = (
    FEATURE_SET_BUZZER | FEATURE_SET_CHILD_LOCK | FEATURE_SET_LED | FEATURE_SET_FAVORITE_LEVEL
)
...
FEATURE_FLAGS_AIRPURIFIER_V3: Final = FEATURE_SET_BUZZER | FEATURE_SET_CHILD_LOCK | FEATURE_SET_LED
...
FEATURE_FLAGS_AIRHUMIDIFIER_JSQ1: Final = (
    FEATURE_SET_BUZZER | FEATURE_SET_LED | FEATURE_SET_TARGET_HUMIDITY | FEATURE_SET_WET_PROTECTION
)
...
FEATURE_FLAGS_AIRHUMIDIFIER_JSQ: Final = (
    FEATURE_SET_BUZZER | FEATURE_SET_LED | FEATURE_SET_LED_BRIGHTNESS | FEATURE_SET_CHILD_LOCK
)
...
FEATURE_FLAGS_AIRDEHUMIDIFIER: Final = (
    FEATURE_SET_BUZZER | FEATURE_SET_CHILD_LOCK | FEATURE_SET_LED | FEATURE_SET_TARGET_HUMIDITY
)
...
OPERATION_MODES_AIRFRESH: Final = [
    "Auto",
    "Silent",
    "Interval",
    "Low",
